...
CLIENT.setAuthorizationToken = function(token){
  this.token = token;
}

CLIENT.apiAuthCall = function(method, path, params, callback) {
    callback = callback || function() {};
    return request({method: method, uri: _soundcloud_api_url + path + '?oauth_token=' + token + '&' + querystring.stringify(params), json:true}, callback);
};
